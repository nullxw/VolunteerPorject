...
- (void)_setupFieldType:(XHFieldType)fieldType {
    ...
    switch (_fieldType) {
        case kXHEmailField:
            leftImage = [UIImage imageNamed:kEmailImageName];
            break;
        case kXHUserNameField:
            leftImage = [UIImage imageNamed:@"user"];
            break;
        case kXHPasswordField:
            leftImage = [UIImage imageNamed:@"lock"];
            break;
        case kXHConstellation:
            leftImage = [UIImage imageNamed:kConstellationImageName];
            break;
            case kXHAvatarField:
...
//        [self setTintColor:[UIColor blackColor]];
    ...
    // 工具条上的按钮
    self.previousBarButton = [[UIBarButtonItem alloc] initWithTitle:@"上一项" style:UIBarButtonItemStyleBordered target:self action:@selector(previousButtonIsClicked:)];
