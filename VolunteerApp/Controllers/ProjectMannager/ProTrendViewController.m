//
//  ProTrendViewController.m
//  VolunteerApp
//
//  Created by zelong zou on 14-3-9.
...
@implementation ProTrendViewController
...
- (void)viewDidLoad {
    ...
    __weak ProTrendViewController *weakSelf = self;
...
- (void)refreshData
{
    [self.view showLoadingViewWithString:@"正在加载..."];
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    if (itemCount == 0 ) {
                        if ([curList count]==0) {
                            ...
                            [mytableView addCenterMsgView:@"暂无数据"];
                        }else{
                            [mytableView.pullToRefreshView stopAnimating];
